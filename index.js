 ...
 * }
*/
function makePersonObject(newPersonId, newPersonName, newPersonEmail) {
  let newObject = {id: newPersonId, name: newPersonName, email: newPersonEmail};
  return newObject;
}
...
function carMaker(num) { 
  let car = {
      odometer: num,
      drive: (distance) => {return car.odometer += distance}, 
    }
    return car;
}
